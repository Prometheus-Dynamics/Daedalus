...
DAEDALUS_PLUGIN("{plugin_name}", "0.1.0", "cpp test plugin")
"#
    );
...
DAEDALUS_PLUGIN("{plugin_name}", "0.1.0", "cpp auto-symbol test plugin")
"#
    );
...
fn write_manifest(out_dir: &Path, lib_path: &Path, prefix: &str) -> PathBuf {
    ...
    let doc = serde_json::json!({
      "manifest_version": "1",
      "language": "c_cpp",
      "plugin": { "name": prefix, "version": "0.1.0", "description": "cpp test", "metadata": {} },
      "nodes": [
        {
